...
**Levels at different companies**


When a job advert is posted, it always maps to one or more levels internally.  This level information might or might not be exposed on the job listing itself.  For example, a Software Engineer job listing on the Google site might have an internal mapping of levels L4 or L5 against it.


While there are no universal mappings between what each level means at each company, there are decent approximations. The Senior level at Google (L5) usually translates to L5 at Facebook, L6 at Amazon, and anywhere from 63 to 65 at Microsoft. The site [Levels.fyi](https://www.levels.fyi/) does a good job visualizing these levels. Keep in mind, though, that these levels are approximations, and there are no exact mappings between companies.


![Image represents a comparison chart showing equivalent engineering levels across five major tech companies: Google, Facebook, Uber, Amazon, and Microsoft.  The chart is arranged as a grid with each company's levels listed in a separate column.  Rows represent increasing seniority levels, progressing from entry-level to highly senior positions like Google Fellow and Technical Fellow.  Google's levels are labeled L3 through L10, with corresponding titles like 'SWE II' and 'Distinguished Engineer.' Facebook uses E3 through E9. Uber uses titles like 'Software Engineer I' and 'Principal Engineer' with numerical level indicators (3-7). Amazon uses 'SDE I' through 'Principal SDE' with level indicators (L4-L7). Microsoft uses numerical level indicators (59-80) with titles like 'SDE' and 'Technical Fellow.'  Each cell shows the equivalent level across companies, allowing for a direct comparison of seniority and title between organizations.  There's no explicit information flow between cells; the chart simply presents a static mapping of equivalent roles.](https://bytebytego.com/images/courses/tech-resume/p2-c1-tech-resume-basics/10-7TFVF7VT.png)

*Mapping of levels between several companies on Levels.fyi. The mapping is not exact, but it gives a sense of progression at each company, and how these might compare between companies.*
...
![Image represents a snippet of a tech resume belonging to Greg Rossing, who identifies as a Backend Developer.  The top section displays his name ('GREG ROSSING') and job title ('BACKEND DEVELOPER'), both underlined in a muted green. Below this, a paragraph summarizes his skills and experience, highlighting his 9 years of experience as a result-driven backend engineer with expertise in migrating monolithic systems to microservices and a strong interest in distributed systems and modern software architecture.  Further down, a 'WORK HISTORY' section, also underlined in muted green, details his current role as 'Senior backend developer' at 'SkyLabs,' starting in May 2018 and continuing to the present.  A bullet point under this describes a key achievement: leading a team of 5 engineers to migrate a booking service monolith into 7 loosely coupled microservices.  The entire structure is vertically arranged, with clear section headings and consistent formatting, creating a clean and easily readable resume excerpt.](https://bytebytego.com/images/courses/tech-resume/p2-c1-tech-resume-basics/11-7OTNYKOE.png)
...
![Image represents a tech resume for Greg Rossing, a Backend Developer.  The top section displays his name ('GREG ROSSING') and job title ('BACKEND DEVELOPER') in a header-like format. Below, a brief professional summary describes him as a result-driven backend engineer with nine years of experience in migrating monoliths to microservices and a keen interest in distributed systems.  To the right, a black and white headshot of Greg Rossing is shown, accompanied by personal details: Nationality (Ukraine), Age (47 years), and Marital Status (married with two young kids). The lower section, titled 'WORK HISTORY,' details his current role as a Senior Backend Developer at SkyLabs, starting in May 2018 and continuing to the present.  A bullet point under this describes a key achievement: leading a team of five engineers to migrate a booking service monolith to seven loosely coupled microservices.  The overall layout is clean and organized, with clear section headings and a professional tone.](https://bytebytego.com/images/courses/tech-resume/p2-c1-tech-resume-basics/12-U7I3UDF6.png)
...
**From the inside out: does not having a photo reduce my chances of getting hired?**


In some countries, photos are expected on CVs. Two recruiters working in these markets give their take on whether you should add photos.


Yinka Coker has previously recruited at Andela, and spent a considerable time hiring in the United Arab Emirates. Here’s what he says about photos in the Middle East:


*“In the UAE and most of the Middle East, photos are expected on CVs for all roles, even tech roles. However, there is a cultural shift happening, reflecting the adoption of inclusive hiring practices. It is always better to tailor your CV to the local hiring practices in countries you apply to.”*


Konstanty Sliwowski has been recruiting for nearly two decades in London, UK and Berlin, Germany. Heading up his recruitment agency, he’s recruited for the likes of Delivery Hero, GetYourGuide and several high-growth startups and tech companies. Here’s what he has to say about the unimportance of photos:


*“No client of ours has ever rejected a CV because the application didn’t have a photo. At my agency, we do not believe a photo is necessary, despite most German companies receiving CVs with photos.”*


Tech is one of the industries where not having a photo on a CV is rarely an issue. Do your research for specific countries, and reach out for local recruiters and hiring managers for specific advice.
