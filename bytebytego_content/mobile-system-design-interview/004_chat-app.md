...
**\u{1F4DD} Note!** This is how SSE works under the hood:
...
**\u{1F4DD} Note:** The components identified in the chat system don't differ much from those identified in the previous chapter when designing a News Feed. Thus, we'll go through this section quickly. If you have questions, revisit Chapter 3: Design a News Feed App.
...
**\u{1F4DD} Note:** For a deeper dive into comparing different storage alternatives, refer to the Data Storage section in Chapter 10: Mobile System Design Building Blocks.
...
**\u{1F4DD} Note:** For the data model's IDs, we use an INTEGER in the SQLite statement even if that's represented as a Long in Kotlin or Int64 in Swift.
...
**\u{1F4CC} Remember!** Mobile clients should perform all database operations on a background thread to prevent blocking the UI thread and ensure a responsive user experience.
