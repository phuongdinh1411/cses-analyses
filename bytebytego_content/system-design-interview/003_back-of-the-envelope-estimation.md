...
| Compress 1K bytes with Zippy | 10,000 ns = 10 \xB5s |
| Send 2K bytes over 1 Gbps network | 20,000 ns = 20 \xB5s |
| Read 1 MB sequentially from memory | 250,000 ns = 250 \xB5s |
| Round trip within the same datacenter | 500,000 ns = 500 \xB5s |
...
ns = nanosecond, \xB5s = microsecond, ms = millisecond


1 ns = 10^-9 seconds


1 \xB5s= 10^-6 seconds = 1,000 ns


1 ms = 10^-3 seconds = 1,000 \xB5s = 1,000,000 ns
