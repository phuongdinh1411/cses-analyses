...
![Image represents a mobile application screen displaying a list of nearby friends.  The top displays the time (10:52), battery level (82%), and a settings icon. A back arrow is present to navigate back. The title 'Nearby Friends' is prominently displayed, followed by the location 'NEAR SAN FRANCISCO, CA'. Below this, a list of friends appears, each represented by a colored icon (purple, gold, dark-grey, light-blue, and green for Mallow Smith, Alice, Oliver, Ava, and Frank respectively) and their distance from the user in miles (0.5 mi, 1.3 mi, 2 mi, 2.5 mi, and 3 mi respectively). At the bottom of the screen, a navigation bar is present with icons and labels for 'News Feed,' 'Requests,' 'Messenger,' 'Notifications,' and 'More' options.  The overall layout is a vertically stacked structure, with the friend list occupying the majority of the screen's central area.](https://bytebytego.com/images/courses/system-design-interview/nearby-friends/figure-1-facebook-nearby-friends-XALOYO46.png)
...
![Image represents a map divided into a grid of nine equal-sized sections, overlaid on a street map showing roads, buildings, and a park labeled 'Reservoir Recreation Area'. Each section is labeled with a unique alphanumeric identifier, such as '9q8zn6', '9q8znd', etc.  Four green circles are plotted on the map, located within different sections.  These circles are not explicitly labeled but appear to represent data points or locations within the gridded area. The map's base layer shows street names like '21st Avenue', '23rd Avenue', and 'East 24th Street', indicating geographical context. The bottom of the image includes attribution text: 'Map tiles by Stamen Design, under CC BY 3.0. Data \xA9 OpenStreetMap contributors.'  The grid lines appear to be a superimposed structure for organizing or analyzing the data represented by the green circles within the geographical context of the underlying street map.](https://bytebytego.com/images/courses/system-design-interview/nearby-friends/figure-14-nine-geohash-grids-IGQKWUYU.png)
...
[1] Facebook Launches “Nearby Friends”: [https://techcrunch.com/2014/04/17/facebook-nearby-friends/](https://techcrunch.com/2014/04/17/facebook-nearby-friends/)


[2] Redis Pub/Sub: [https://redis.io/topics/pubsub](https://redis.io/topics/pubsub)


[3] Redis Pub/Sub under the hood: [https://jameshfisher.com/2017/03/01/redis-pubsub-under-the-hood/](https://jameshfisher.com/2017/03/01/redis-pubsub-under-the-hood/)
...
[6] Consistent hashing: [https://www.toptal.com/big-data/consistent-hashing](https://www.toptal.com/big-data/consistent-hashing)
...
[10] A brief introduction to BEAM: [https://www.erlang.org/blog/a-brief-beam-primer/](https://www.erlang.org/blog/a-brief-beam-primer/)
