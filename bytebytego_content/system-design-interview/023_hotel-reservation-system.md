...
- total*reserved: the total number of rooms booked for the specified _hotel_id*, *room_type_id,* and *date*.
...
**date****total_inventory****total_reserved**2021-07-01100972021-07-02100962021-07-0310095
...
[7] Optimistic concurrency control: [https://en.wikipedia.org/wiki/Optimistic_concurrency_control](https://en.wikipedia.org/wiki/Optimistic_concurrency_control)


[8] Change data capture: [https://docs.oracle.com/cd/B10500_01/server.920/a96520/cdc.htm](https://docs.oracle.com/cd/B10500_01/server.920/a96520/cdc.htm)
...
[12] Two-phase commit protocol: [https://en.wikipedia.org/wiki/Two-phase_commit_protocol](https://en.wikipedia.org/wiki/Two-phase_commit_protocol)
