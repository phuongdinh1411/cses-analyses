...
- Understand sliding window problems with target sum constraints and length minimization
- Apply sliding window technique to find shortest subarray with sum at least target
