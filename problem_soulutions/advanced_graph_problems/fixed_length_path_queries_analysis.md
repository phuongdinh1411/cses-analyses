...
A¹ (paths of length 1):
    1  2  3  4
1 [ 0  1  0  1 ]  ← A[1][4] = 1 (direct edge 1→4)
2 [ 1  0  1  0 ]
3 [ 0  1  0  1 ]
4 [ 1  0  1  0 ]
...
A² (paths of length 2):
    1  2  3  4
1 [ 2  0  2  0 ]  ← A[1][4] = 0 (no path 1→4 of length 2)
2 [ 0  2  0  2 ]
3 [ 2  0  2  0 ]
4 [ 0  2  0  2 ]
...
A³ (paths of length 3):
    1  2  3  4
1 [ 0  4  0  4 ]  ← A[1][4] = 4 (multiple paths 1→4 of length 3)
2 [ 4  0  4  0 ]
3 [ 0  4  0  4 ]
4 [ 4  0  4  0 ]
```
...
Walk: Vertices can be repeated
- 1 → 2 → 1 → 4 ✓

Trail: No repeated edges
- 1 → 2 → 3 → 4 ✓
- 1 → 2 → 1 → 2 → 4 ✓ (repeated vertices OK)
```
