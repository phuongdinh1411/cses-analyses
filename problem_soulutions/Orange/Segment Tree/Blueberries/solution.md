...
def solve():
    ...
    for case in range(1, t + 1):
        ...
        # Cap each bush at K using list comprehension
        berries = [min(b, k) for b in map(int, input().split())]
...
def solve():
    ...
    for case in range(1, t + 1):
        ...
        # Cap at K using list comprehension
        berries = [min(b, k) for b in map(int, input().split())]
        ...
        if n == 0:
            ...
            prev2, prev1 = berries[0], max(berries[0], berries[1])

            for b in berries[2:]:
                prev2, prev1 = prev1, max(prev1, prev2 + b)
